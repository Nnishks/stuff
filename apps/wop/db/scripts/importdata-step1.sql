...
TRUNCATE TABLE public."FFAattachments" CASCADE;

TRUNCATE TABLE public."FFAsurveysections" CASCADE;

TRUNCATE TABLE public."FFAsurvey" CASCADE;

TRUNCATE TABLE public."Lookbook" CASCADE;
...
INSERT INTO public."Tenants"(id, customername, uniqueid, hostname, bucketname, region, foldername, secretkey, accesskey, isdeleted, createdat, updatedat)
	VALUES (100, 'Panda Express', 'PX', 'https:s3.aws.com', 'nexfmx', 'asia-pacific', 'panda_express','1234secretkey', '45678accesskey', false, NOW(), NOW());
...
INSERT INTO public."User"(id, name, email, phone, address, city, stateorprovince, country, postalcode, officephone, homephone, alternateemail, manager, "hashedPassword", role, profile, "tenantId", isdeleted, "createdAt", "updatedAt")
	VALUES (-2, 'System Adminstrator', 'sysadmin@nexfmx.io', '0000000000', 'address', 'city', 'state', 'us','100000','', '','',-2,'JGFyZ29uMmlkJHY9MTkkbT02NTUzNix0PTIscD0xJHF4eVU5ZnZnamFsaXcvcXlQZXY4SnckVzBOYkFyZnc3dTFkZjR2RTIzZVNoVjhYNENpK0pKeWFQd0xpNkFiUEtLWQAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=',10, 'admin', 100, false, NOW(), NOW());

INSERT INTO public."User"(id, name, email, phone, address, city, stateorprovince, country, postalcode, officephone, homephone, alternateemail, manager, "hashedPassword", role, profile, "tenantId", isdeleted, "createdAt", "updatedAt")
	VALUES (1, 'Facility Manager 1', 'fm1@nexfmx.io', '0000000000', 'address', 'city', 'state', 'us','100000','', '','',-2,'JGFyZ29uMmlkJHY9MTkkbT02NTUzNix0PTIscD0xJHF4eVU5ZnZnamFsaXcvcXlQZXY4SnckVzBOYkFyZnc3dTFkZjR2RTIzZVNoVjhYNENpK0pKeWFQd0xpNkFiUEtLWQAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=',13, 'manager', 100, false, NOW(), NOW());
INSERT INTO public."User"(id, name, email, phone, address, city, stateorprovince, country, postalcode, officephone, homephone, alternateemail, manager, "hashedPassword", role, profile, "tenantId", isdeleted, "createdAt", "updatedAt")
	VALUES (2, 'Facility Manager 2', 'fm2@nexfmx.io', '0000000000', 'address', 'city', 'state', 'us','100000','', '','',-2,'JGFyZ29uMmlkJHY9MTkkbT02NTUzNix0PTIscD0xJHF4eVU5ZnZnamFsaXcvcXlQZXY4SnckVzBOYkFyZnc3dTFkZjR2RTIzZVNoVjhYNENpK0pKeWFQd0xpNkFiUEtLWQAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=',13, 'manager', 100, false, NOW(), NOW());

INSERT INTO public."User"(id, name, email, phone, address, city, stateorprovince, country, postalcode, officephone, homephone, alternateemail, manager, "hashedPassword", role, profile, "tenantId", isdeleted, "createdAt", "updatedAt")
	VALUES (3, 'General Manager 1', 'gm1@nexfmx.io', '0000000000', 'address', 'city', 'state', 'us','100000','', '','',-2,'JGFyZ29uMmlkJHY9MTkkbT02NTUzNix0PTIscD0xJHF4eVU5ZnZnamFsaXcvcXlQZXY4SnckVzBOYkFyZnc3dTFkZjR2RTIzZVNoVjhYNENpK0pKeWFQd0xpNkFiUEtLWQAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=',14, 'manager', 100, false, NOW(), NOW());
INSERT INTO public."User"(id, name, email, phone, address, city, stateorprovince, country, postalcode, officephone, homephone, alternateemail, manager, "hashedPassword", role, profile, "tenantId", isdeleted, "createdAt", "updatedAt")
	VALUES (4, 'General Manager 2', 'gm2@nexfmx.io', '0000000000', 'address', 'city', 'state', 'us','100000','', '','',-2,'JGFyZ29uMmlkJHY9MTkkbT02NTUzNix0PTIscD0xJHF4eVU5ZnZnamFsaXcvcXlQZXY4SnckVzBOYkFyZnc3dTFkZjR2RTIzZVNoVjhYNENpK0pKeWFQd0xpNkFiUEtLWQAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=',14, 'manager', 100, false, NOW(), NOW());
...
INSERT INTO public."Picklist"( id, tenantid, name, uniquename, description, "valueName", "createdAt", "updatedAt") VALUES (DEFAULT,100,'Asset Condition','asset_condition','Asset Condition','Working','NOW()','NOW()');
INSERT INTO public."Picklist"( id, tenantid, name, uniquename, description, "valueName", "createdAt", "updatedAt") VALUES (DEFAULT,100,'Asset Condition','asset_condition','Asset Condition','Inoperable','NOW()','NOW()');
INSERT INTO public."Picklist"( id, tenantid, name, uniquename, description, "valueName", "createdAt", "updatedAt") VALUES (DEFAULT,100,'Asset Condition','asset_condition','Asset Condition','Condemned','NOW()','NOW()');